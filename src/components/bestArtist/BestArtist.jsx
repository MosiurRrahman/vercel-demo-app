...
function BestArtist() {
  ...
  return (
    <div className="best-artist-area style-light pt-110">
        ...
        <div className="row title-gap gy-4 align-items-center">
          ...
          <div className="col-lg-2">
            <div className="slider-arrows text-center d-lg-flex d-none  justify-content-end gap-4">
              <div
                className="artist-prev swiper-prev-arrow"
                tabIndex={0}
                role="button"
                aria-label="Previous slide"
              >
                {" "}
                <img src="assets/images/icon/swiper-left.svg" alt="" />{" "}
              </div>
              <div
                className="artist-next swiper-next-arrow"
                tabIndex={0}
                role="button"
                aria-label="Next slide"
              >
                {" "}
                <img src="assets/images/icon/swiper-right.svg" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <Swiper {...slider} className="swiper artist-slider swiper-negetive-space-x">
            <div className="swiper-wrapper pb-1">
              <SwiperSlide className="swiper-slide ">
                <div className="artist-alpha style-light">
                  ...
                  <div className="artist-disc">
                    ...
                    <p className="artist-id">WER-2553</p>
                    <div className="artist-disc-footer">
                      <div className="totol-art">
                        <img
                          src="assets/images/icon/collection-bug.svg"
                          alt=""
                        />{" "}
                        <span>23 Art</span>
                      </div>
              ...
              <SwiperSlide className="swiper-slide ">
                <div className="artist-alpha style-light">
                  ...
                  <div className="artist-disc">
                    ...
                    <p className="artist-id">WER-3422</p>
                    <div className="artist-disc-footer">
                      <div className="totol-art">
                        <img
                          src="assets/images/icon/collection-bug.svg"
              ...
              <SwiperSlide className="swiper-slide ">
                <div className="artist-alpha style-light">
                  ...
                  <div className="artist-disc">
                    ...
                    <p className="artist-id">WER-1245</p>
                    <div className="artist-disc-footer">
                      <div className="totol-art">
                        <img
                          src="assets/images/icon/collection-bug.svg"
              ...
              <SwiperSlide className="swiper-slide ">
                <div className="artist-alpha style-light">
                  ...
                  <div className="artist-disc">
                    ...
                    <p className="artist-id">WER-1183</p>
                    <div className="artist-disc-footer">
                      <div className="totol-art">
                        <img
                          src="assets/images/icon/collection-bug.svg"
