...
function Header6() {
  ...
  return (
    <header ref={headerRef} className={`header-area2 style-2 two ${state.scrollY > 10 ? "sticky":""}`}>
        ...
        <div className={`main-menu ${state.isSidebarOpen  ? "show-menu" : ""}`}>
            ...
            <li className="menu-item-has-children">
                <a href="#" className={`drop-down ${state.activeMenu === "service" ? "active" : ""}`}
              onClick={() => toggleMenu("service")}>Service</a> <i
            ...
            <li className="menu-item-has-children">
                <a href="#" className="drop-down">Project</a><i
              className={`bi bi-plus dropdown-icon ${state.activeMenu === "project" ? "active" : ""}`}
              onClick={() => toggleMenu("project")}
            />
                <ul className={`sub-menu ${state.activeMenu === "project" ? "d-block" : ""}`}>
            ...
            <li className="menu-item-has-children">
                ...
                <li>
                    <Link legacyBehavior href="/team1"><a>Team</a></Link>
                    <i className="d-lg-flex d-none bi bi-chevron-right dropdown-icon" />
                    <i className={`bi bi-plus dropdown-icon ${state.activeSubMenu === "team" ? "active" : ""}`} onClick={() => toggleSubMenu("team")} />
                    <ul className={`sub-menu ${state.activeSubMenu === "team" ? "d-block" : ""}`}>
                    <li><Link legacyBehavior href="/team1"><a>Team 01</a></Link></li>
                    <li><Link legacyBehavior href="/team2"><a>Team 02</a></Link></li>
                    <li><Link legacyBehavior href="/team3"><a>Team 03</a></Link></li>
                    </ul>
                </li>
                <li>
                    <Link legacyBehavior href="/pricing"><a>Pricing</a></Link>
                    <i className={`bi bi-plus dropdown-icon ${state.activeSubMenu === "price" ? "active" : ""}`} onClick={() => toggleSubMenu("price")} />
                    <ul className={`sub-menu ${state.activeSubMenu === "price" ? "d-block" : ""}`}>
                    <li><Link legacyBehavior href="/pricing"><a>Pricing 01</a></Link></li>
                    <li><Link legacyBehavior href="/pricing2"><a>Pricing 02</a></Link></li>
                    </ul>
                </li>
                <li><Link legacyBehavior href="/contact"><a>Contact</a></Link></li>
                <li><Link legacyBehavior href="/faq"><a>FAQs</a></Link></li>
                <li><Link legacyBehavior href="/error"><a>Error 404</a></Link></li>
                </ul>
            </li>
            <li className="menu-item-has-children">
                <a href="#" className={`drop-down ${state.activeMenu === "case" ? "active" : ""}`}>Case Study</a><i className={`bi bi-plus dropdown-icon ${state.activeMenu === "case" ? "active" : ""}`}
              onClick={() => toggleMenu("case")}  />
                <ul className={`sub-menu ${state.activeMenu === "case" ? "d-block" : ""}`}>
                <li><Link legacyBehavior href="/case-study"><a>Case study 01</a></Link></li>
                <li><Link legacyBehavior href="/case-study2"><a>Case study 02</a></Link></li>
                <li><Link legacyBehavior href="/case-study-standard"><a>Case study standard</a></Link></li>
                <li><Link legacyBehavior href="/case-study-details"><a>Case study Details</a></Link></li>
                </ul>
            </li>
            <li className="menu-item-has-children">
                <a href="#" className={`drop-down ${state.activeMenu === "blog" ? "active" : ""}`}
              onClick={() => toggleMenu("blog")}>Blog</a><i className={`bi bi-plus dropdown-icon ${state.activeMenu === "blog" ? "active" : ""}`}
        ...
        <div className="header-contact d-xl-block d-none">
            ...
            <h6><a href="Tel:29658728617">2-965-871-8617</a></h6>
        </div>
        <div className="header-btn d-sm-flex d-none">
            <Link legacyBehavior href="/contact"><a>Get A Quote</a></Link>
        </div>
