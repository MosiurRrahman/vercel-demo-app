            ...
            <Swiper {...slider} className="swiper home4-insight-slider">
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="home4-insights-card">
                    <div className="insight-img">
                      <img className="img-fluid" src="assets/img/home-4/insight-01.png" alt="" />
                    </div>
                    <div className="insight-content">
                      <ul>
                        <li><Link legacyBehavior href="/blog"><a>Web development</a></Link></li>
                        <li><Link legacyBehavior href="/blog"><a>May 10, 2023</a></Link></li>
                      </ul>
                      <h4><Link legacyBehavior href="/blog-details"><a>In a augue sit amet erat Si
                          eleifend suscpit.</a></Link></h4>
                      <p>Software development is the process of creatin computer software programs that perform opel specific functions or tasks.</p>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="home4-insights-card">
                    <div className="insight-img">
                      <img className="img-fluid" src="assets/img/home-4/insight-02.png" alt="" />
                    </div>
                    <div className="insight-content">
                      <ul>
                        <li><Link legacyBehavior href="/blog"><a>Digital marketing</a></Link></li>
                        <li><Link legacyBehavior href="/blog"><a>May 10, 2023</a></Link></li>
                      </ul>
                      <h4><Link legacyBehavior href="/blog-details"><a>Strategies and Best Practic for Effective.</a></Link></h4>
                      <p>Software development is the process of creatin computer software programs that perform opel specific functions or tasks.</p>
                      <div className="read-btn">
                      <Link legacyBehavior href="/blog-details">
                          <a className="primary-btn5">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="home4-insights-card">
                    <div className="insight-img">
                      <img className="img-fluid" src="assets/img/home-4/insight-03.png" alt="" />
                    </div>
                    <div className="insight-content">
                      <ul>
                        <li><Link legacyBehavior href="/blog"><a>Cloud solutions</a></Link></li>
                        <li><Link legacyBehavior href="/blog"><a>May 03, 2023</a></Link></li>
                      </ul>
                      <h4><Link legacyBehavior href="/blog-details"><a>Navigating the Journey of Cloud Solution.</a></Link></h4>
                      <p>Software development is the process of creatin computer software programs that perform opel specific functions or tasks.</p>
                      <div className="read-btn">
                      <Link legacyBehavior href="/blog-details">
                          <a className="primary-btn5">
