...
function BlogMasonaryPage() {
  ...
  <div className="container">
    <div className="row divider justify-content-lg-between justify-content-center g-lg-4 gy-5">
      <div className="col-lg-5 col-md-6 wow animate fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
      ...
      <div className="col-lg-5 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="single-blog magnetic-item">
          <div className="blog-img">
      ...
      <div className="col-lg-5 col-md-6 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
        <div className="single-blog magnetic-item">
          <div className="blog-img">
