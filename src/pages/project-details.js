        ...
        <div className="details-navigation">
          <div className="single-navigation">
            <div className="content">
              <Link legacyBehavior href="/project-details"><a>Previous</a></Link>
              <h4><Link legacyBehavior href="/project-details"><a>Streamlining IT Infrastructure</a></Link></h4>
            </div>
          ...
          <div className="single-navigation two">
            ...
            <div className="content">
              <Link legacyBehavior href="/project-details"><a>NEXT </a></Link>
              <h4><Link legacyBehavior href="/project-details"><a>Scaling Agile Development</a></Link></h4>
            </div>
          </div>
        </div>
      </div>
