...
function Team2Page() {
  ...
  <div className="container"> 
    <div className="row g-4 justify-content-center">
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
        <div className="single-team magnetic-item">
          <div className="team-img">
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
        <div className="single-team magnetic-item">
          <div className="team-img">
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
        <div className="single-team magnetic-item">
          <div className="team-img">
            <img className="img-fluid" src="assets/img/home-3/team-08.png" alt="" />
            <div className="social-area">
              <ul>
                <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
                <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
        <div className="single-team magnetic-item">
          <div className="team-img">
            <img className="img-fluid" src="assets/img/home-3/team-05.png" alt="" />
            <div className="social-area">
              <ul>
                <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
                <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
        <div className="single-team magnetic-item">
          <div className="team-img">
            <img className="img-fluid" src="assets/img/home-3/team-06.png" alt="" />
            <div className="social-area">
              <ul>
                <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
                <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="single-team magnetic-item">
          <div className="team-img">
            <img className="img-fluid" src="assets/img/home-3/team-07.png" alt="" />
            <div className="social-area">
              <ul>
                <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
                <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
